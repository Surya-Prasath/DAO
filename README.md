...
1. Clone this repo:
```
git clone https://github.com/Surya-Prasath/DAO
cd dao-template
```
...
See the [open issues](https://github.com/Surya-Prasath/DAO/issues) for a full list of proposed features (and known issues).
...
Surya Prasath - [@Surya](https://twitter.com/_SuryaPrasath_)
